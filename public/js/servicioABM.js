angular.module('ServicioABM', ['ngTable', 'Mutual.services'])
    ...
    this.create = function (data, url){
        return $http({
            ...
            UserSrv.MostrarMensaje("OK", "Elemento dado de alta correctamente.", "OK", "mensaje");
    ...
    return paramsABMS;
        ...
        this.push = function ( data, url, id) {
            return $http({
                ...
                UserSrv.MostrarMensaje("OK", "Elemento editado correctamente.", "OK", "mensaje");
                $('#editar').modal('toggle');
            }, function errorCallback(response) {
        ...
        this.delete = function (url, id) {
            ...
            return $http({
                ...
                UserSrv.MostrarMensaje("OK", "Elemento eliminado correctamente.", "OK", "mensaje");
            }, function errorCallback(response) {
