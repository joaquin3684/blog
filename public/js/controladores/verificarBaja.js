        ...
        '<div id="verificarBaja" class="modal fade" role="dialog">'+
           ...
           ' <div class="modal-content">'+
                ...
                '<div class="modal-body" style="display: inline-flex;">'+
                    '<h5 >¿Desea eliminar a &nbsp</h5><h5 style="color: red">{{abm.nombre}}{{abm.razon_social}}{{abm.usuario}} </h5><h5>&nbsp de la lista de elementos?</h5>'+
                    
               ' </div>'+
                '<div class="modal-footer">'+
                    '<button type="button" class="btn btn-primary" data-dismiss="modal" ng-click="delete(abm.id)">Aceptar</button>'+
