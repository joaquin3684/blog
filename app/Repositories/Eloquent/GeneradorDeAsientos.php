...
class GeneradorDeAsientos
{
    ...
    public static function crear($cuenta, $debe, $haber, $fechaValor = null)
    {
        ...
        $fechaVal = $fechaValor == null ? Carbon::today()->toDateString() : $fechaValor;
        ...
        $asientos->create(['id_imputacion' => $cuenta, 'debe' => $debeNuevo, 'haber' => $haberNuevo, 'id_ejercicio' => $ejercicio->id, 'fecha_contable' => $fechaContable, 'fecha_valor' => $fechaVal, 'nro_asiento' => $nroAsiento]);
