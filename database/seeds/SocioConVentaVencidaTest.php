...
class SocioConVentaVencidaTest extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::transaction(function ()  use ($hoy, $vto){
            ...
            $venta1 = factory(\App\Ventas::class)->states('vencida 3 meses')->create(['id_producto' => $producto1->id, 'nro_credito' => 1]);
            $venta2 = factory(\App\Ventas::class)->states('vencida 3 meses')->create(['id_producto' => $producto2->id, 'nro_credito' => 2]);
