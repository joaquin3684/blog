@extends('welcome') @section('contenido') {!! Html::script('js/controladores/solicitudesPendientesDeCobro.js') !!}


<div class="nav-md" ng-controller="solicitudesPendientesDeCobro">
    ...
    <div class="container body">
        ...
        <div class="main_container">
            ...
            @if(Sentinel::check()->hasAccess('solicitudesPendientesDeCobro.visualizar'))
