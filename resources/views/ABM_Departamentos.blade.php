...
<div class="nav-md" ng-controller="ABMWizard" >
  ...
  <div class="container body">
    ...
    <div class="main_container" >
      ...
      <input type="hidden" id="tablon" ng-value="departamento">
      <!-- page content -->
        ...
        <div class="" >
          ...
          <div class="row" >
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel"  >
                <div class="x_title">
                  <h2>ABM Departamentos<small>Dar de alta un departamento</small></h2>
    ...
    <section>
        <div class="wizard">
            <div class="wizard-inner">
                ...
                <div class="tab-pane active" role="tabpanel" id="departamento">
                  ...
                  <form role="form" class="" ng-submit="enviarFormulario('departamento','Alta')" id="departamentoform">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4 col-sm-4 col-xs-12">
                            <select id="id_moneda" class="form-control col-md-7 col-xs-12" name="id_moneda" ng-model="nose" required>
                            <option value="{{x.id}}" ng-repeat="x in selectmonedas">
                            {{x.nombre}}
                            </option>
                            </select>{{errores.id_moneda[0]}}
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4 col-sm-4 col-xs-12">
                            <input required id="codigo" class="form-control col-md-7 col-xs-12" name="codigo" placeholder="Ingrese el código" type="text">{{errores.codigo[0]}}
                        </div>
                      </div>
