@extends('welcome') @section('contenido') {!! Html::script('js/controladores/AprobarServiciosCtr.js') !!}
                                    ...
                                    <table ng-table="paramsAprobaciones" class="table table-hover table-bordered">
                                        ...
                                        <tbody data-ng-repeat="aprobacion in $data" data-ng-switch on="dayDataCollapse[$index]">
                                            <tr class="clickableRow" title="" data-ng-click="selectTableRow($index,cuota.id_cuota)" ng-cloak>
                                                ...
                                                <td>
                                                    @if(Sentinel::check()->hasAccess('aprobacionServicios.crear'))
                                                    <input type="button" ng-click="Aprobar('ok',aprobacion.id)" class="btn btn-primary" value="✓"> @endif @if(Sentinel::check()->hasAccess('aprobacionServicios.borrar'))
                                                    <input type="button" ng-click="Aprobar('no',aprobacion.id)" class="btn btn-danger" value="X"> @endif
                                                </td>
                                            </tr>
