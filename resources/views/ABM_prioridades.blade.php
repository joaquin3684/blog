@extends('welcome') @section('contenido') {!! Html::script('js/angular-ui-sortable/src/sortable.js') !!} {!! Html::script('js/controladores/prioridades.js')
!!}
            ...
            <table id="datatable-responsive" cellspacing="0" class="table table-striped " cellspacing="0" width="100%">
              ...
              <tbody ui-sortable="sortableOptions" ng-model="datos">
                <tr ng-repeat="x in datos">
                  <td>{[{x.nombre}]}</td>
                  <td>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editar" ng-click="enviarFormulario('Mostrar', x.id)">
                      <span class="glyphicon glyphicon-pencil"></span>
                    </button>
                    <button type="button" class="btn btn-danger" ng-click="enviarFormulario('Borrar', x.id)">
