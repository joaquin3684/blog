@extends('welcome') @section('contenido') {!! Html::script('js/controladores/proveedor_cc.js') !!}

<div class="nav-md" ng-controller="proveedor_cc">
        ...
        <div class="main_container">
            ...
            <div class="left-col" role="main">
                <div class="">
                    ...
                    @if(Sentinel::check()->hasAccess('CCProovedor.visualizar'))
                                    ...
                                    <form ng-submit="filtro()">
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="filterOrganismo" ng-if="vistaactual=='Organismos'">
                                                <md-autocomplete md-item-text="item.organismo" md-no-cache="true" md-search-text-change="buscandoOrganismos(searchText4)"
                                                    md-selected-item-change="filtrar()" md-items="item in query(searchText4)"
                                                    md-search-text="searchText4" md-selected-item="organismo" placeholder="Buscar organismo...">
                                                    <md-item-template>
                                            ...
                                            <div id="filterSocio" ng-if="vistaactual=='Socios'">
                                                <div class="row">
                                                    <md-autocomplete md-item-text="item.socio" md-no-cache="true" md-search-text-change="buscandoSocios(searchText)" md-selected-item-change="filtrar()"
                                                        md-items="item in query(searchText)" md-search-text="searchText" md-selected-item="socio"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1 col-sm-1 col-xs-4">
                                                        <input class="form-control col-md-7 col-xs-12" ng-change="filtrar()" id="minimo" name="minimo" ng-model="minimo_importe_cuota"
                                                            type="number"> {{errores.porcentaje_retencion[0]}}
                                                        </input>
                                                    </div>
                                                    <div class="item form-group col-sm-5 col-xs-8">
                                                        <label class="control-label col-md-6 col-sm-6 col-xs-12" for="minimo">
                                            ...
                                            <div id="filterProveedor" ng-if="vistaactual=='Ventas' || vistaactual =='Cuotas'">
                                                <md-autocomplete md-item-text="item.proovedor" md-no-cache="true" md-search-text-change="buscandoProovedores(searchText2)"
                                                    md-items="item in query(searchText2)" md-selected-item-change="filtrar()"
                                                    md-search-text="searchText2" md-selected-item="proovedor" placeholder="Buscar proovedor...">
                                                    <md-item-template>
                                                        <span md-highlight-text="searchText">
                                                            {{item.proovedor}}
                                                        </span>
                                            ...
                                            <div id="filterProducto" ng-if="vistaactual=='Ventas'">
                                                <md-autocomplete md-item-text="item.producto" md-no-cache="true" md-search-text-change="buscandoProductos(searchText3)" md-items="item in query(searchText3)"
                                                    md-selected-item-change="filtrar()" md-search-text="searchText3" md-selected-item="producto"
                                        ...
                                        <div class="row" style="margin-top:20px;" id="filterCuota" ng-show="vistaactual=='Ventas || Cuotas'">
                                            ...
                                            <div class="col-md-1 col-sm-1 col-xs-4">
                                                <input class="form-control col-md-7 col-xs-12" ng-change="filtrar()" id="minimo" name="minimo" ng-model="maximo_importe_cuota"
                                                    type="number"> {{errores.porcentaje_retencion[0]}}
                                                </input>
                                            </div>
                                        </div>
                                        <div class="row" id="filterCuota2" ng-show="vistaactual=='Ventas || Cuotas'">
                                            <div class="item form-group col-sm-5 col-xs-8">
                                                ...
                                                <md-slider aria-label="red" flex="" id="red-slider" ng-change="filtrar()" max="255" min="0" ng-model="minimo_nro_cuota">
                                                </md-slider>
                                            </div>
                                            <div class="col-md-1 col-sm-1 col-xs-4">
                                                <input class="form-control col-md-7 col-xs-12" ng-change="filtrar()" id="minimo" name="minimo" ng-model="minimo_nro_cuota"
                                                    type="number"> {{errores.porcentaje_retencion[0]}}
                                                </input>
                                            </div>
                                            <div class="item form-group col-sm-5 col-xs-8">
                                            ...
                                            <div class="col-md-1 col-sm-1 col-xs-4">
                                                <input class="form-control col-md-7 col-xs-12" ng-change="filtrar()" id="minimo" name="minimo" ng-model="maximo_nro_cuota"
                                                    type="number"> {{errores.porcentaje_retencion[0]}}
                                                </input>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top:20px;" id="filterFecha" ng-show="vistaactual == 'Ventas'">
                                            <div class="item form-group col-sm-6 col-xs-12">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12" ng-change="filtrar()" id="desde" ng-model="desde" name="desde" placeholder="Ingrese la cuota social"
                                                        type="date"> {{errores.porcentaje_retencion[0]}}
                                                    </input>
                                                </div>
                                            </div>
                                            <div class="item form-group col-sm-6 col-xs-12">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12" ng-change="filtrar()" id="hasta" ng-model="hasta" name="hasta" placeholder="Ingrese la cuota social"
                                                        type="date"> {{errores.porcentaje_retencion[0]}}
                                                    </input>
                                                </div>
                                            </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr style="background-color: #A6A6A6; color: white;" data-ng-repeat="movimiento in cuota.movimientos">
                                                                        ...
                                                                        <td>
                                                                            <center>{{movimiento.gastos_administrativos}}</center>
                                                                        </td>
