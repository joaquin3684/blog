@extends('welcome') @section('contenido') {!! Html::script('js/controladores/mayorContable.js') !!}



<div class="nav-md" ng-controller="mayorContable">
                                                        ...
                                                        <div>
                                                            <table class="table table-striped">
                                                                <thead style="background-color: #337ab7; color: white;">
                                                                    <tr>
                                                                        <th>
                                                                            <a href="#" ng-click="sortBy('fechaContable')" style="color: white">
                                                                                Fecha contable
                                                                            </a>
                                                                            <span ng-show="propertyName === 'fechaContable'" class="sortorder" ng-class="{reverse: reverse}"></span>
                                                                        </th>
                                                                        <th>
                                                                            <a href="#" ng-click="sortBy('fechaValor')" style="color: white">
                                                                                Fecha valor
                                                                            </a>
                                                                            <span ng-show="propertyName === 'fechaValor'" class="sortorder" ng-class="{reverse: reverse}"></span>
                                                                        </th>
                                                                        <th>
                                                                            <a href="#" ng-click="sortBy('nroAsiento')" style="color: white">
                                                                                Nro asiento
                                                                            </a>
                                                                        ...
                                                                        <th>
                                                                            ...
                                                                            <span ng-show="propertyName === 'debe'" class="sortorder" ng-class="{reverse: reverse}"></span>
                                                                        </th>
                                                                        <th>
                                                                            <a href="#" ng-click="sortBy('haber')" style="color: white">
                                                                                Haber
                                                                            </a>
                                                                            <span ng-show="propertyName === 'haber'" class="sortorder" ng-class="{reverse: reverse}"></span>
                                                                        </th>
                                                                        <th>
                                                                            <a href="#" ng-click="sortBy('saldo')" style="color: white">
                                                                                Saldo
                                                                            </a>
                                                                            <span ng-show="propertyName === 'saldo'" class="sortorder" ng-class="{reverse: reverse}"></span>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr ng-repeat="asiento in reporte.asientos | orderBy:propertyName:reverse">

                                                                        <td>
                                                                            <center>{{cambiarFormato(asiento.fecha_contable)}}</center>
                                                                        </td>
                                                                        <td>
                                                                            <center>{{cambiarFormato(asiento.fecha_valor)}}</center>
                                                                        </td>
                                                                        <td>
