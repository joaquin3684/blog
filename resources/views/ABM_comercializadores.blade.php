                                    ...
                                    <form class="form-horizontal form-label-left" id="formulario"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="nombre" class="form-control col-md-7 col-xs-12" name="nombre"
                                                       placeholder="Juan"
                                                       type="text" ng-model="nombreComerc">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="apellido" name="apellido"
                                                       class="form-control col-md-7 col-xs-12" placeholder="Perez"
                                                       ng-model="apellidoComerc">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" id="cuit" name="cuit" required
                                                       class="form-control col-md-7 col-xs-12" placeholder="00123456780"
                                                       ng-model="cuitComerc">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" id="documento" name="documento"
                                                       class="form-control col-md-7 col-xs-12" placeholder="12345678"
                                                       ng-model="documentoComerc">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="email" name="email"
                                                       ...
                                                       placeholder="email@hotmail.com" ng-model="emailComerc">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="domicilio" name="domicilio"
                                                       class="form-control col-md-7 col-xs-12"
                                                       placeholder="Av. 9 de Julio 1234"
                                                       ng-model="domicilioComerc">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select required ng-model="estadoCivilComerc" name="estado_civil"
                                                        class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" id="telefono" name="telefono"
                                                       class="form-control col-md-7 col-xs-12" placeholder="1123456789"
                                                       ng-model="telefonoComerc">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="contraseña" name="tcontraseña"
                                                       class="form-control col-md-7 col-xs-12" placeholder="Contr123"
                                                       ng-model="contraseniaComerc">
                                                <div ng-cloak>{{errores.password[0]}}</div>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                   for="porcentaje_colocacion">Porc. colocacion
                                                <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" step="0.01" id="porcentaje_colocacion"
                                                       name="porcentaje_colocacion"
                                                       class="form-control col-md-7 col-xs-12"
                                                       placeholder="1" ng-model="porcentaje_colocacionComerc">
                                                <div ng-cloak>{{errores.porcentaje_colocacion[0]}}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
                                                <button type="button" ng-click="borrarFormulario()"
                                    ...
                                    <tr class="clickableRow" title="Datos" ng-cloak>
                                        ...
                                        <td id="botones">
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#editar" ng-click="traerElemento(abm.id)">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left" ng-submit="editarFormulario(abmConsultado.id)"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control col-md-7 col-xs-12" name="nombre"
                                       ng-model="abmConsultado.nombre" required>
                                <div ng-cloak>{{errores.nombre[0]}}</div>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" step="0.01" id="apellido" name="apellido"
                                       class="form-control col-md-7 col-xs-12"
                                       placeholder="Ingrese el apellido del comercializador"
                                       ng-model="abmConsultado.apellido" required>
                                <div ng-cloak>{{errores.apellido[0]}}</div>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" id="cuit" name="cuit" class="form-control col-md-7 col-xs-12"
                                       placeholder="Ingrese el cuit" ng-model="abmConsultado.cuit"
                                       required>
                                <div ng-cloak>{{errores.cuit[0]}}</div>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" id="documento" name="documento"
                                       class="form-control col-md-7 col-xs-12" placeholder="Ingrese el Documento"
                                       ng-model="abmConsultado.dni" required>
                                <div ng-cloak>{{errores.dni[0]}}</div>
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="domicilio" name="domicilio"
                                       class="form-control col-md-7 col-xs-12" placeholder="Ingrese el Domicilio"
                                       ng-model="abmConsultado.domicilio" required>
                                <div ng-cloak>{{errores.domicilio[0]}}</div>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control col-md-7 col-xs-12"
                                       ...
                                       ng-model="abmConsultado.provincia" required>
                                <div ng-cloak>{{errores.provincia[0]}}</div>
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="porcentaje_colocacion">Porc.
                                Colocacion
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" step="0.01" id="porcentaje_colocacion" name="porcentaje_colocacion"
                                       class="form-control col-md-7 col-xs-12"
                                       placeholder="Ingrese el porcentaje"
                                       ng-model="abmConsultado.porcentaje_colocacion" required>
                                <div ng-cloak>{{errores.porcentaje_colocacion[0]}}</div>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select required  ng-model="abmConsultado.estado_civil" class="form-control col-md-7 col-xs-12">
                                    <option value="casado">Casado</option>
                                    <option value="soltero">Soltero</option>
                                    <option value="viudo">Viudo</option>
                                    <option value="divorsiado">Divorciado</option>
