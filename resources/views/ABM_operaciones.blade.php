    ...
    <div class="main_container">
      ...
      <div class="left-col" role="main">
        ...
        <div class="">
          ...
          <div id="mensaje"></div>
          <div class="row">
            @if(Sentinel::check()->hasAccess('operaciones.crear'))
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" id="formulario" ng-submit="submit()">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="apellido">Tipo
                        <span class="required">*</span>
                      </label>
                      <div class="col-md-2 col-sm-2 col-xs-6">
                        <div class="radio">
                          <label>
                            <input type="radio" ng-model="entrada" ng-click="modificar('salida')" ng-value="1" ng-required="salida == 0 && entrada ==0">Ingreso</label>
                        </div>
                      </div>
                      <div class="col-md-2 col-sm-2 col-xs-6">
                        <div class="radio">
                          <label>
                            <input type="radio" ng-model="salida" ng-click="modificar('entrada')" ng-value="1">Egreso</label>
                        </div>
                      </div>
                    </div>

                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cuit">Asiento
                        <span class="required">*</span>
                      </label>
                      ...
                      <div class="col-md-1 col-sm-1 col-xs-6">
                        <div class="radio">
                          <label>
                            <input type="radio" ng-model="cuenta1Debe" ng-click="modificar('cuenta1Haber')" ng-value="1" ng-required="cuenta1Debe == 0 && cuenta1Haber ==0">Debe</label>
                        </div>
                      </div>
                      <div class="col-md-1 col-sm-1 col-xs-6">
                        <div class="radio">
                          <label>
                            <input type="radio" ng-model="cuenta1Haber" ng-click="modificar('cuenta1Debe')" ng-value="1">Haber</label>
                        </div>
                      </div>
                    </div>

                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Asiento
                        <span class="required">*</span>
                      </label>
                      <div class="col-md-4 col-sm-4 col-xs-12">
                      ...
                      <div class="col-md-1 col-sm-1 col-xs-6">
                        <div class="radio">
                          <label>
                            <input type="radio" ng-checked="cuenta1Haber == 1" disabled>Debe</label>
                        </div>
                      </div>
                      <div class="col-md-1 col-sm-1 col-xs-6">
                        <div class="radio">
                          <label>
                            <input type="radio" ng-checked="cuenta1Debe == 1" disabled>Haber</label>
                        </div>
                      </div>
                    </div>
      ...
      @if(Sentinel::check()->hasAccess('operaciones.visualizar'))
      
        <div class="x_panel">
          <div class="x_title">
            <h2>Operaciones de caja
              <small>Todas las operaciones disponibles</small>
            </h2>
            <ul class="nav navbar-right panel_toolbox">
              <li>
                <a class="collapse-link">
                  ...
                  <table id="tablita" ng-table="paramsABMS" class="table table-hover table-bordered">
                    ...
                    <tbody data-ng-repeat="abm in $data" data-ng-switch on="dayDataCollapse[$index]">
                      <tr class="clickableRow" title="Datos" ng-cloak>
                        ...
                        <td id="botones">
                        @endverbatim
                         @if(Sentinel::check()->hasAccess('operaciones.editar'))
          ...
          <form class="form-horizontal form-label-left" ng-submit="editarFormulario(abmConsultado.id)" id="formularioEditar">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="col-md-4 col-sm-4 col-xs-6">
                  <div class="radio">
                    <label>
                      <input type="radio" ng-model="abmConsultado.entrada" ng-checked="abmConsultado.entrada == 1" ng-click="modificar2('abmConsultado','salida')"
                        ng-value="1">Ingreso</label>
                  </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6">
                  <div class="radio">
                    <label>
                      <input type="radio" ng-model="abmConsultado.salida" ng-checked="abmConsultado.salida == 1" ng-click="modificar2('abmConsultado','entrada')"
                        ng-value="1">Egreso</label>
                  </div>
                </div>
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-2 col-sm-2 col-xs-6">
                <div class="radio">
                  <label>
                    <input type="radio" ng-model="abmConsultado.debe1" ng-click="modificar2('abmConsultado','haber1')" ng-value="1">Debe</label>
                </div>
              </div>
              <div class="col-md-2 col-sm-2 col-xs-6">
                <div class="radio">
                  <label>
                    <input type="radio" ng-model="abmConsultado.haber1" ng-click="modificar2('abmConsultado','debe1')" ng-value="1">Haber</label>
                </div>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-2 col-sm-2 col-xs-6">
                <div class="radio">
                  <label>
                    <input type="radio" ng-checked="abmConsultado.haber1 == 1" disabled>Debe</label>
                </div>
              </div>
              <div class="col-md-2 col-sm-2 col-xs-6">
                <div class="radio">
                  <label>
                    <input type="radio" ng-checked="abmConsultado.debe1 == 1" disabled>Haber</label>
                </div>
              </div>
            </div>
