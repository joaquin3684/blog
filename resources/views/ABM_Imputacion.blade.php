...
<div class="nav-md" ng-controller="ABMWizard" >
  ...
  <div class="container body">
    ...
    <div class="main_container" >
      ...
      <input type="hidden" id="tablon" ng-value="imputacion">
      <!-- page content -->
        ...
        <div class="" >
          ...
          <div class="row" >
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel"  >
                <div class="x_title">
                  <h2>ABM Imputacion<small>Dar de alta una imputacion</small></h2>
                  ...
                  <form role="form" class="" ng-submit="enviarFormulario('imputacion','Alta')" id="imputacionform">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4 col-sm-4 col-xs-12">
                            <select required id="id_subrubro" class="form-control col-md-7 col-xs-12" name="id_subrubro" ng-model="nose">
                            <option value="{{x.id}}" ng-repeat="x in selectsubrubros">
                            {{x.nombre}}
                            </option>
                            </select>{{errores.id_subrubro[0]}}
                        </div>
                      </div>
