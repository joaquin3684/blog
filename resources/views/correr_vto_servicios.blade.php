@extends('welcome') @section('contenido') {!! Html::script('js/controladores/correr_vto_servicios.js') !!}
    ...
    <div class="main_container">
      ...
      <div class="left-col" role="main">
        ...
        <div class="">
          ...
          <div id="mensaje"></div>
          <div class="row">
            @if(Sentinel::check()->hasAccess('correrVtoServicios.visualizar'))
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Postergar vencimiento
                    <small>Postergar el vencimiento de una cuota</small>
                  </h2>
                  ...
                  <table id="tablita" ng-table="paramsABMS" class="table table-hover table-bordered">
                    ...
                    <tbody data-ng-repeat="abm in $data" data-ng-switch on="dayDataCollapse[$index]">
                      <tr class="clickableRow" title="Datos" ng-cloak>
                        ...
                        @endverbatim @if(Sentinel::check()->hasAccess('correrVtoServicios.editar'))
                        <td title="'Cambiar fecha'" sortable="'cantDias'">
                          <div class="input-group">
                            <input type="text" class="form-control" placeholder="Cantidad de dias" ng-model="cantDias">
                            <div class="input-group-btn">
                              <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Accion
                                <span class="caret"></span>
                              </button>
                              <ul class="dropdown-menu dropdown-menu-right">

                                <li>
                                  <a href="#" ng-click="confirmarCambios(abm.fecha_vencimiento, cantDias, abm.id)">Postergar</a>
                                </li>
                                <li>
                                  <a href="#" ng-click="confirmarCambios(abm.fecha_vencimiento, cantDias * -1, abm.id)">Adelantar</a>
                                </li>
                              </ul>
                            </div>
                            <!-- /btn-group -->
