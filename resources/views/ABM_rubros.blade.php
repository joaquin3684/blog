...
<div class="nav-md" ng-controller="ABMWizard" >
  ...
  <div class="container body">
    ...
    <div class="main_container" >
      ...
      <input type="hidden" id="tablon" ng-value="rubro">
      <!-- page content -->
        ...
        <div class="" >
          ...
          <div class="row" >
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel"  >
                <div class="x_title">
                  <h2>ABM Rubros<small>Dar de alta un rubro</small></h2>
    ...
    <section>
        <div class="wizard">
            <div class="wizard-inner">
                ...
                <div class="tab-pane active" role="tabpanel" id="rubro">
                  ...
                  <form role="form" class="" ng-submit="enviarFormulario('rubro','Alta')" id="rubroform">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4 col-sm-4 col-xs-12">
                            <select required id="id_rubro" class="form-control col-md-7 col-xs-12" name="id_rubro" ng-model="nose">
                            <option value="{{x.id}}" ng-repeat="x in selectcapitulos">
                            {{x.nombre}}
                            </option>
                            </select>{{errores.id_rubro[0]}}
                        </div>
                      </div>
